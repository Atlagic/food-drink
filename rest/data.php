			...
			<div id="central">
					<?php
						if(isset($_REQUEST['btnSubmit']))
						{
							...
							//echo $Name." ".$LastName." ".$Email." ".$UserName." ".$Password;
							...
							{
								echo "<div style='color:red'>Name is in wrong format!</div>";
							}
							else if(!preg_match($lastName, $LastName))
							{
								echo "<div style='color:red'>Lastname is in wrong format!</div>";
							}
							else if(!preg_match($email, $Email))
							{
								echo "<div style='color:red'>Email is in wrong format!!</div>";
							}
							...
							{
								echo("<div style='width:450px;height:200px;color:white;border:1px solid black; margin-top:50px; margin-left:680px; padding-left:100px; padding-top:50px; background-color:black;' text-align:center;"."</br>");
		
								echo "Thanks for ragistration! Here is your informations: <br/>";
